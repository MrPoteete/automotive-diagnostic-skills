...
// Server-side proxy to backend /vehicle/tsbs — mirrors existing proxy patterns.
...
export async function GET(req: NextRequest) {
    try {
        ...
        const res = await fetch(
            `${BACKEND_URL}/vehicle/tsbs?${backendParams.toString()}`,
        ...
        console.error('/api/vehicle/tsbs error:', err);
