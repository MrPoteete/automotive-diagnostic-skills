...
def scan_for_injections(
    ...
    categories = [
        ...
        ("Multi-Language Injection", "multiLanguagePatterns"),
    ]
    ...
    for category_name, config_key in categories:
        ...
        for item in patterns:
            ...
            try:
                # Use IGNORECASE, MULTILINE, and DOTALL flags
                # DOTALL ensures multi-line injections (split across newlines) are caught
